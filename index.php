...
<p>Данные в CSV: <a href="esr.csv">ЕСР</a>, <a href="osm2esr.csv">OSM-ЕСР</a>, <a href="express.csv">Экспресс</a>, <a href="crimea.csv">станции Крыма</a>.<p>
...
print "<p><b>По регионам</b> | <a href=./railways>По железным дорогам</a></p>";
...
foreach ($regions as $region)
{
  ...
  {
    ?>
      <tr><td><?php if($region["iso3166"]) print $region["iso3166"]; else print "&nbsp;"; ?></td><td><?php if($region["country"]) print "&raquo;"; ?> <a href="./region:<?php print $region["source"]; ?>:l">
...
<li>Обновлено - время последнего удачного запуска робота для этого региона.
<li>Источник данных - <a href="https://osm.org/">OpenStreetMap</a>.
</ul>
<p>Статус планового обновления: <b><?php print file_get_contents("status"); ?></b>
...
<br>&copy; <a href="https://github.com/shurshur/osmesr/">Исходный код</a> доступен по лицензии <a href="http://www.gnu.org/licenses/gpl.html">GPL 3.0</a>.
